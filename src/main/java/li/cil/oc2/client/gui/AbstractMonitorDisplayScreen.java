...
public abstract class AbstractMonitorDisplayScreen<T extends AbstractMonitorContainer> extends AbstractModContainerScreen<T> {
    ...
    protected void renderFg(final PoseStack stack, final float partialTicks, final int mouseX, final int mouseY) {
        ...
        terminalWidget.render(stack, Component.translatable(Constants.COMPUTER_ERROR_NOT_ENOUGH_ENERGY));
    }

    @Override
    protected void renderBg(final PoseStack graphics, final float partialTicks, final int mouseX, final int mouseY) {
    ...
    @Override
    protected void renderTooltip(final PoseStack graphics, final int mouseX, final int mouseY) {
    ...
    @Override
    protected void renderLabels(final PoseStack graphics, final int mouseX, final int mouseY) {
