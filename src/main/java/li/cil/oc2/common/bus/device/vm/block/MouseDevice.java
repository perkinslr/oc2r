...
public final class MouseDevice<T> extends IdentityProxy<T> implements VMDevice {
    ...
    @Nullable private VirtIOMouseDevice device;
    ...
    public MouseDevice(final T identity) {
        super(identity);
    }

    ///////////////////////////////////////////////////////////////

    public void sendMouseEvent(final int keycode, final boolean isDown) {
        if (device != null) {
            device.sendMouseEvent(0x03, keycode, isDown ? 0 : 1);
        }
    }
    ...
    private boolean allocateDevice(final VMContext context) {
        ...
        device = new VirtIOMouseDevice(context.getMemoryMap());
